...
/**
 * NOTE:
 * this doesn't implement Observer, unlike EditItemActivity,
 * because Item/ItemList class only notifies observers on set methods i.e. modification
 * and not on Item/ItemList constructor i.e. creation method of Item
 *
 */
